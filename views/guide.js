...
<head>
  ...
  <title>Documentación | Hiragana API REST</title>
  ...
  <div id="app">
    <header>
      <div class="container flex items-center justify-between mx-auto">
        ...
        <nav class="flex">
          <a class="py-2 px-4" href="/">Inicio</a>
          <a class="py-2 px-4 bg-gray-800" href="/guide">Documentación</a>
        </nav>
      </div>
    </header>
